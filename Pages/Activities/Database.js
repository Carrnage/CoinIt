...
// db.transaction(tx => {
//   tx.executeSql(
//     'CREATE TABLE IF NOT EXISTS Payment (id INTEGER PRIMARY KEY AUTOINCREMENT, senderEmail varchar(30), receiverEmail varchar(30), amount decimal(5,2), createDate datetime, paymentdate datetime, status varchar(10))',
//     [],
//     (sqlTnx, reg)=>{
//       console.log("Table has been created successful");
//     },
